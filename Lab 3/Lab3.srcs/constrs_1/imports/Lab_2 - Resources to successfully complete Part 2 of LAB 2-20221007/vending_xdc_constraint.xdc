...
##Switches
set_property -dict {PACKAGE_PIN G15    IOSTANDARD LVCMOS33} [ get_ports { input_sw[2] }];
set_property -dict {PACKAGE_PIN P15    IOSTANDARD LVCMOS33} [ get_ports { input_sw[1] }];
set_property -dict { PACKAGE_PIN W13   IOSTANDARD LVCMOS33 } [get_ports { input_sw[0] }]; #IO_L4N_T0_34 Sch=sw[2]
set_property -dict { PACKAGE_PIN T16   IOSTANDARD LVCMOS33 } [get_ports { entered_input }]; #IO_L9P_T1_DQS_34 Sch=sw[3]
...
#set_property -dict { PACKAGE_PIN F17   IOSTANDARD LVCMOS33 } [get_ports { led5_g }]; #IO_L6N_T0_VREF_35 Sch=led6_g
set_property -dict { PACKAGE_PIN M17   IOSTANDARD LVCMOS33 } [get_ports { done_signal }]; #IO_L8P_T1_AD10P_35 Sch=led6_b
